 ...
 */
    ...
    (() => {
        ...
        const resizableSwiper = (breakpoint, swiperClass, swiperSettings, callback) => {
            ...
            const checker = function() {
                if (breakpoint.matches) return enableSwiper(swiperClass, swiperSettings); else {
                    if (void 0 !== swiper) swiper.destroy(true, true);
                    return;
                }
            };
        ...
        window.addEventListener("load", (function(e) {
            resizableSwiper("(max-width: 853px)", ".stack__slider", {
                modules: [ Pagination ],
                spaceBetween: 30,
                slidesPerView: 2,
                slidesPerGroup: 2,
            ...
            resizableSwiper("(max-width: 692px)", ".projects__slider", {
                modules: [ Pagination ],
                spaceBetween: 25,
                pagination: {
                    el: ".swiper-pagination"
        ...
        const clipboard_clipboard = new clipboard("#button-copy", {
            text: function(trigger) {
                return document.getElementById("input").value;
            }
        });
        clipboard_clipboard.on("success", (function(e) {
            alert("Реферальная ссылка скопирована: " + e.text);
            e.trigger.classList.add("btn-success");
            setTimeout((function() {
                e.trigger.classList.remove("btn-success");
            }), 3e3);
        }));
        clipboard_clipboard.on("error", (function(e) {
